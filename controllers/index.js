...
router.use('/api', expressJWT({ secret: process.env.DINDINSSECRET || "Secret" }).unless({ path: ['/api/users/login', '/api/products' ,'/api/users']}), function (error, request, response, next) {
